...
import com.cy.strarryui.widget.alpha.AlphaFrameLayout;

/**
 * @author Duckbb
 */
public class StarryFrameLayout extends AlphaFrameLayout implements IStarryLayout {

    private StarryLayoutHelper mLayoutHelper;

    public StarryFrameLayout(@NonNull Context context) {
        this(context, null);
    }

    public StarryFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StarryFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @IStarryLayout.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    public void setHalfRadius(boolean halfRadius) {
        mLayoutHelper.setHalfRadius(halfRadius);
    }
