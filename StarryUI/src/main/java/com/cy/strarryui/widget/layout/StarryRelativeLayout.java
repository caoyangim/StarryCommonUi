...
import com.cy.strarryui.widget.alpha.AlphaRelativeLayout;

/**
 * @author Duckbb
 */
public class StarryRelativeLayout extends AlphaRelativeLayout implements IStarryLayout {
    private StarryLayoutHelper mLayoutHelper;

    public StarryRelativeLayout(Context context) {
        this(context, null);
    }

    public StarryRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StarryRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
