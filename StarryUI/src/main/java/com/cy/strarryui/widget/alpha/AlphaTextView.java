...
public class AlphaTextView extends AppCompatTextView {
    ...
    public AlphaTextView(@NonNull final Context context) {
        super(context);
    }

    public AlphaTextView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
    }

    public AlphaTextView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
